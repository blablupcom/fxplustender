    ...
    for portal in portals:
        ...
        for link in links:
            ...
            #     print "got tender " + linkcont + " already."
                ...
                scraperwiki.sqlite.save(unique_keys=['l'], data={"l": unicode(link), "tender_id": unicode(tender_id), "buyer": unicode(buyer), "title" : unicode(title), "summary": unicode(summary), "categories": unicode(categories), "contact_name": unicode(contact_name), "contact_phone": unicode(contact_phone), "contact_email": unicode(contact_email), "contact_addr": unicode(contact_addr), "contract_start": unicode(contract_start), "contract_end": unicode(contract_end), "eoi_start": unicode(eoi_start), "eoi_end": unicode(eoi_end), "est_value": unicode(est_value), "contract_duration": unicode(contract_duration),"extension_duration": unicode(extension_duration), "extension_iterations": unicode(extension_iterations), "attach_list": unicode(attach_list), "d": unicode(todays_date) })
